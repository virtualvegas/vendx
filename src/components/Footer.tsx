    ...
    <footer className="relative border-t border-border/50">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="mailto:info@vendx.space"
                className="w-10 h-10 rounded-full bg-accent/10 border border-accent/30 flex items-center justify-center hover:border-accent hover:shadow-[0_0_20px_rgba(57,255,136,0.5)] transition-smooth"
              >
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© 2025 VendX Global Corporation. All rights reserved.</p>
