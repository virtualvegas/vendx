...
const ReleaseTracksManager = ({ mediaType }: ReleaseTracksManagerProps = {}) => {
  ...
  const openEditRelease = (r: Release) => {
    ...
    setReleaseForm({
      ...
      runtime_minutes: r.runtime_minutes?.toString() || "",
      mpaa_rating: r.mpaa_rating || "",
      language: r.language || "English",
      country: r.country || "",
      director: r.director || "",
      writers: r.writers?.join(", ") || "",
      producers: r.producers?.join(", ") || "",
      cast_members: r.cast_members?.join(", ") || "",
      synopsis: r.synopsis || "",
      season_count: r.season_count?.toString() || "",
      episode_count: r.episode_count?.toString() || "",
      imdb_url: r.imdb_url || "",
