...
import { Wallet, Receipt, Repeat, PiggyBank, Package, TrendingUp, Clock } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Accounts, income, expenses, pending invoices, subscriptions, tax vault & inventory reinvestment.</p>
      </div>
