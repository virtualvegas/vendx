...
const tabGroups: TabGroup[] = [
  ...
  // === MEDIA & ENTERTAINMENT ===
  {
    ...
    tabs: [
      { id: "music-artists", label: "Music Artists", icon: Users, requiredRoles: r("music-artists") },
      { id: "filmmakers", label: "Filmmakers", icon: Film, requiredRoles: r("filmmakers") },
      { id: "music-releases", label: "Music Releases", icon: Music, requiredRoles: r("music-releases") },
      { id: "film-releases", label: "Film Releases", icon: Film, requiredRoles: r("film-releases") },
