...
// Configuration
const SITE_NAME = "vendx"
const SENDER_DOMAIN = "notify.vendxglobal.net"
const ROOT_DOMAIN = "vendxglobal.net"
const FROM_DOMAIN = "vendxglobal.net" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://vendx.lovable.app"
