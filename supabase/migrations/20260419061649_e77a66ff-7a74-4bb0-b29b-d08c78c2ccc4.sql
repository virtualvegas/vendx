-- Update import to include ecosnack/ecovend locker purchases alongside machine_transactions
...
BEGIN
  ...
  -- 1. Standard machine transactions (snack, beverage, arcade, claw, etc.)
  WITH inserted AS (
  ...
  -- 2. EcoVend / EcoSnack locker purchases (only paid ones)
